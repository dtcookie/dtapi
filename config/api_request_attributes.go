...
func (a *RequestAttributesApiService) ValidateConfiguration5(ctx context.Context, id string, localVarOptionals *ValidateConfiguration5Opts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *RequestAttributesApiService) ValidateConfiguration6(ctx context.Context, localVarOptionals *ValidateConfiguration6Opts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
