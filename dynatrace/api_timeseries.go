...
*/
func (api TimeseriesAPI) CreateCustomTimeseries(timeseriesIdentifier string, c *environment.TimeseriesRegistrationMessage) (environment.TimeseriesDefinition, error) {
	result, _, err := api.client.TimeseriesApi.CreateCustomTimeseries(nil, timeseriesIdentifier, &environment.CreateCustomTimeseriesOpts{
...
@return []TimeseriesDefinition
*/
func (api TimeseriesAPI) GetAllTimeseriesDefinitions(opts *environment.GetAllTimeseriesDefinitionsOpts) ([]environment.TimeseriesDefinition, error) {
...
*/
func (api TimeseriesAPI) ReadTimeseriesComplex(timeseriesIdentifier string, opts *environment.ReadTimeseriesComplexOpts) (environment.TimeseriesQueryResultWrapper, error) {
...
*/
func (api TimeseriesAPI) ReadTimeseriesComplexWithoutPathParam(opts *environment.ReadTimeseriesComplexWithoutPathParamOpts) error {
...
*/
func (api TimeseriesAPI) ReadTimeseriesData(timeseriesIdentifier string, opts *environment.ReadTimeseriesDataOpts) ([]environment.TimeseriesQueryResult, error) {
